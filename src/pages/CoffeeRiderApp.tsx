...
const CoffeeRiderApp = () => {
  ...
  const starterMessage = encodeURIComponent("Halo, saya tertarik dengan Coffee Rider App - Starter Package. Mohon informasi lebih lanjut.");
  const earlyBirdMessage = encodeURIComponent("Halo, saya tertarik dengan Coffee Rider App - Early Bird Package. Mohon informasi lebih lanjut.");
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-amber-700 max-w-2xl mx-auto mb-8">
            Sistem lengkap untuk rider coffee mobile shop. Catat penjualan harian, 
            laporan otomatis untuk admin, dan perhitungan gaji yang akurat.
          </p>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto">
          ...
          <p className="text-center text-amber-700 mb-12 max-w-xl mx-auto">
            Mulai kelola bisnis coffee mobile shop Anda dengan sistem yang terintegrasi
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="relative border-2 border-amber-200 bg-white/80 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader className="text-center pb-2">
                <CardTitle className="text-2xl text-amber-900">Starter Package</CardTitle>
                <CardDescription className="text-amber-600">Untuk memulai bisnis Anda</CardDescription>
              </CardHeader>
            ...
            <Card className="relative border-2 border-amber-400 bg-gradient-to-br from-amber-50 to-orange-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
              ...
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="text-2xl text-amber-900">Early Bird Package</CardTitle>
                <CardDescription className="text-amber-600">Penawaran terbatas!</CardDescription>
              </CardHeader>
              <CardContent className="text-center">
                <div className="mb-2">
                  <div className="text-lg text-amber-500 line-through">Rp 240.000</div>
                  <div className="text-5xl font-bold text-amber-900">
      ...
      <section className="py-16 px-6 bg-amber-900">
        <div className="container mx-auto text-center">
          ...
          <p className="text-amber-200 mb-8 max-w-xl mx-auto">
            Hubungi kami sekarang untuk demo gratis dan konsultasi kebutuhan bisnis Anda
          </p>
          <Button
            asChild
            size="lg"
